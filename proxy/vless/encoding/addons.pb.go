...
const file_proxy_vless_encoding_addons_proto_rawDesc = "" +
	"\n" +
	"!proxy/vless/encoding/addons.proto\x12\x19xray.proxy.vless.encoding\"z\n" +
	"\x06Addons\x12\x12\n" +
	"\x04Flow\x18\x01 \x01(\tR\x04Flow\x12\x12\n" +
	"\x04Seed\x18\x02 \x01(\fR\x04Seed\x12\"\n" +
	"\fAuthVerified\x18\x03 \x01(\bR\fAuthVerified\x12$\n" +
	"\rClientVersion\x18\x04 \x01(\tR\rClientVersionBm\n" +
