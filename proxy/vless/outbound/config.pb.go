...
const file_proxy_vless_outbound_config_proto_rawDesc = "" +
	"\n" +
	"!proxy/vless/outbound/config.proto\x12\x19xray.proxy.vless.outbound\x1a!common/protocol/server_spec.proto\"Z\n" +
	"\x06Config\x12:\n" +
	"\x05vnext\x18\x01 \x01(\v2$.xray.common.protocol.ServerEndpointR\x05vnext\x12\x14\n" +
	"\x05relay\x18\x02 \x01(\bR\x05relayBm\n" +
