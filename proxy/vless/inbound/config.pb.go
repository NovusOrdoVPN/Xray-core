...
type Config struct {
	...
	ValidatorEndpoint string                 `protobuf:"bytes,9,opt,name=validator_endpoint,json=validatorEndpoint,proto3" json:"validator_endpoint,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Config) GetValidator() string {
	if x != nil {
		return x.Validator
	}
	return ""
...
func (x *Config) GetValidatorEndpoint() string {
	if x != nil {
		return x.ValidatorEndpoint
	}
	return ""
}
...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	...
	"\apadding\x18\a \x01(\tR\apadding\x12\x1c\n" +
	"\tvalidator\x18\b \x01(\tR\tvalidator\x12-\n" +
	"\x12validator_endpoint\x18\t \x01(\tR\x11validatorEndpointBj\n" +
